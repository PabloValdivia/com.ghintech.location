...
import org.adempiere.webui.window.VEWLocationDialog;
 ...
 **/
public class VEWLocationEditor extends WEditor implements EventListener<Event>, PropertyChangeListener, ContextMenuListener
{
    private static final String[] LISTENER_EVENTS = {Events.ON_CLICK};
    
    private static CLogger log = CLogger.getCLogger(VEWLocationEditor.class);
    private MLocationLookup     m_Location;
    private LVE_MLocation           m_value;
    ...
    **/
    public VEWLocationEditor(String columnName, boolean mandatory, boolean isReadOnly, boolean isUpdateable,
     ...
     * @param gridField
     */
    public VEWLocationEditor(GridField gridField) {
    ...
    public LVE_MLocation getLocation (Object key, String trxName)
	{
		if (key == null)
			return null;
		int C_Location_ID = 0;
    ...
    public LVE_MLocation getLocation (int C_Location_ID, String trxName)
	{
		return LVE_MLocation.get(Env.getCtx(), C_Location_ID, trxName);
	}
    @Override
    ...
    {    
        ...
        if ("onClick".equals(event.getName()))
        {
            ...
            final VEWLocationDialog ld = new VEWLocationDialog(Msg.getMsg(Env.getCtx(), "Location"), m_value, gridField);
            ld.addEventListener(DialogEvents.ON_WINDOW_CLOSE, new EventListener<Event>() {
				...
				public void onEvent(Event event) throws Exception {
		            ...
		            if (C_Location_ID != 0)
		            {
		                ValueChangeEvent vc = new ValueChangeEvent(VEWLocationEditor.this,getColumnName(),null,ii);
		                fireValueChange(vc);
		            }
		            setValue(ii);					
				}
